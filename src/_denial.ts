...
export function verificationAgentInstructions({
  ...
  const baseSteps = [
    'Present the verify_url directly to the user — it is a complete, ready-to-open URL with the session token already embedded (e.g. https://agentscore.com/verify?session=sess_...). Do NOT modify or construct the URL yourself.',
