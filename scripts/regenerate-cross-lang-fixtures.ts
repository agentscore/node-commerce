 ...
 * `tests/identity/cross-lang.test.ts` (and the sibling fixtures) pulls these in
 * alongside the `py-*` fixtures generated by the sibling fixtures.
 *
...
async function main(): Promise<void> {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      payment_handlers: {
        'com.agentscore.payment.tempo': [tempoHandler({ rail: 'tempo-mainnet', chain_id: 4217 })],
        'com.agentscore.payment.x402': [x402Handler(['base-8453'])],
      },
      signing_keys: [publicJWK as UCPSigningKey],
    });
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      payment_handlers: {
        'com.agentscore.payment.stripe_spt': [stripeHandler({ profile_id: 'abc', count: 7 })],
      },
      signing_keys: [publicJWK as UCPSigningKey],
    });
    const signed = await signUCPProfile(profile, { signingKey: privateKey, kid: KID });
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      capabilities: { 'com.agentscore.identity': [customCapability] },
      payment_handlers: {
        'com.agentscore.payment.tempo': [tempoHandler({ rail: 'tempo-mainnet', chain_id: 4217 })],
      },
      signing_keys: [publicJWK as UCPSigningKey],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      payment_handlers: {
        'com.agentscore.payment.tempo': [tempoHandler({ note: 'メモ' })],
      },
      signing_keys: [publicJWK as UCPSigningKey],
    });
    const signed = await signUCPProfile(profile, { signingKey: privateKey, kid: KID });
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      payment_handlers: {
        'com.agentscore.payment.tempo': [tempoHandler({ rail: 'tempo-mainnet' })],
      },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    const profile = buildUCPProfile({
      ...
      payment_handlers: {
        'com.agentscore.payment.tempo': [tempoHandler()],
      },
      signing_keys: [publicJWK as UCPSigningKey],
      extras: {
        a: 1,
